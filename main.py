...
print(Colorate.Vertical(Colors.blue_to_cyan, Center.XCenter("""
                      ...
                      Made By : Danis
        discord.gg/ANJBRPAVMj | Support : 15y 
...
for i in range(num):
	...
	print (Colorate.Horizontal(Colors.yellow_to_green,"[ + ] ยิงเบอร์สำเร็จ"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ10"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ20"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ30"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ40"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ50"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ60"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ70"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ80"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ90"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ100"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ110"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] ยิงเบอร์สำเร็จ120"))
	...
	print (Colorate.Horizontal(Colors.rainbow,"[ + ] เสร็จ130"))
